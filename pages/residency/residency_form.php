     ...
     ?>         
                ...
                <div class="col-xs-12 col-sm-5 col-md-8" style="background: white;  ">`
                    ...
                    <div class="pull-center" style="font-size: 16px;text-align: center;"><b>
                        ...
                        <?php  $qry1=mysqli_query($con,"SELECT * from tblresident r left join tblresidency c on c.residentid = r.id where residentid = '".$_GET['resident']."' ");
                        ...
                        ?>
                        <?php
                            $qry=mysqli_query($con,"SELECT * from tblresident r left join tblresidency c on c.residentid = r.id where residentid = '".$_GET['resident']."'  ");
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p>
                                   ...
                                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Zone'.strtoupper($row['zone']).', Sitio '.strtoupper($row['barangay']).', Sagrada Familia Buhi, Camarines Sur </b><br>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subject:  &nbsp;&nbsp;Certificate of Residency</b><br>
...
<?php
                        ...
                        <p style="font-size: 18px; padding-left:3em; padding-right:3em; text-indent:100px;text-align: justify;">This is to certify that as per record he person whose picture and signature appearing herein is a bonafide resident of this barangay with the following detail/s.
                       <div class="pull-center" style="font-size: 16px;text-align: center;">
                        <p style="font-size: 18px; padding-left:3em; padding-left:3em; text-indent:100px;text-align: justify;">Status of Residency: '.strtoupper($row['sor']).'
                        <div class="pull-center" style="font-size: 16px;text-align: center;">
                        <p style="font-size: 18px; padding-left:3em; padding-left:3em; text-indent:100px;text-align: justify;">Since when: '.strtoupper(date_format($bdate,"m-d-Y")).' / Since birth<br>
                        <div class="pull-center" style="font-size: 16px;text-align: center;">
...
<div class="row">
  ...
  <div class="column"  style="height:70px; width:100px; border: 2px solid black;">
   <center> <h5>RIGHT</h5></center>
    ...
    <button class="btn btn-primary noprint" id="printpagebutton" onclick="PrintElem('#residency')">Print</button>
    </body></left>
    <?php

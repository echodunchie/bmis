        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label>Date: </label>
                    <input name="txt_edit_date" class="form-control input-sm" type="text" value="'.$row['date'].'" />
                </div>
                <div class="form-group">
                    <label>Title: </label>
                ...
                <label>Description: </label>
                     <textarea name="txt_edit_descrip" class="form-control input-sm" type="text" value="'.$row['descrip'].'" />
                </div>

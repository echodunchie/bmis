<?php 
    ...
    class ResidentClass extends BMISClass {
        ...
        public function create_resident() {
            if(isset($_POST['add_resident'])) {
                                       $lname = $_POST['lname'];
                                        ...
                                        $zone = $_POST['zone'];
                                        $totalhousehold = $_POST['householdmem'];
                                        $differentlyabledperson = $_POST['differentlyabledperson'];
                                        $relationtohead = $_POST['relationtohead'];
                                        $bloodtype = $_POST['bloodtype'];
                                        $civilstatus = $_POST['civilstatus'];
                                        $occupation = $_POST['occupation'];
                                        $monthlyincome = $_POST['monthlyincome'];
                                        $householdnum = $_POST['householdnum'];
                                        ...
                                        $houseOwnershipStatus = $_POST['houseOwnershipStatus'];
                                        $landOwnershipStatus = $_POST['landOwnershipStatus'];
                                        $waterUsage = $_POST['waterUsage'];
                                        $lightningFacilities = $_POST['lightningFacilities'];
                ...
                if ($this->check_resident($email) == 0 ) {
                    ...
                    if(!in_array( $age, range( $min_age, $max_age) ) ){
                        ...
                        $stmt = $connection->prepare("INSERT INTO tblresident (`lname`,`fname`,
                        `mname`, `bdate`, `bplace`, `age`, `barangay`, `zone`, `totalhousehold`, `differentlyabledperson`, `relationtohead`, `bloodtype`, `civilstatus`, `occupation`,`monthlyincome` ,`householdnum`, `lengthofstay`, `religion`,`nationality` ,`gender`, `skills`, `highestEducationalAttainment`,`houseOwnershipStatus` ,`landOwnershipStatus`, `waterUsage`, `lightningFacilities`,`formerAddress` ,`remarks`, `username`, `password`) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?)");
    
                        $stmt->Execute([ $lname,$fname, $mname, $bdate, $bplace, $age, $barangay, $zone,$totalhousehold, $differentlyabledperson, $relationtohead, $bloodtype, $civilstatus, $occupation, $monthlyincome , $householdnum, $lengthofstay, $religion,$nationality ,$gender, $skills, $highestEducationalAttainment, $houseOwnershipStatus, $landOwnershipStatus, $waterUsage, $lightningFacilities,$formerAddress , $remarks, $username, $password]);
        ...
        public function view_resident(){
            $connection = $this->openConn();
            $stmt = $connection->prepare("SELECT * from tblresident");
            $stmt->execute();
            $view = $stmt->fetchAll();
            return $view;
        }
        ...
        public function update_resident() {
            if (isset($_POST['update_resident'])) {
                ...
                $connection = $this->openConn();
                $stmt = $connection->prepare("UPDATE tblresident SET `password` =?, `lname` =?, 
                `fname` = ?, `mi` =?, `age` =?, `sex` =?, `status` =?, `email` =?, `houseno` =?, `street` =?,
                `brgy` =?, `municipal` =?, `contact` =?,
                `bdate` =?, `bplace` =?, `nationality` =?, `voter` =?, `family_role` =?, `role` =?, `addedby` =? WHERE `id` = ?");

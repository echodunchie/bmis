    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="row m-0 align-items-center justify-content-between">
                <div class="copyright-text">All Rights Reserved 2022 Barangay Sagrada Buhi Management Information System | Designed By <a target="blank" href="https://www.actwebspace.com"> BSIT4D Hanabi</a></div>
                <ul class="menu">

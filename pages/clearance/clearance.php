                                 ...
                                 <div class="tab-content">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $squery = mysqli_query($con, "SELECT * ,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid FROM tblclearance p left join tblresident r on r.id = p.residentid where r.id = ".$_SESSION['userid']." and status = 'New' ") or die('Error: ' . mysqli_error($con));

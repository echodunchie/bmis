  <?php
   ...
   echo  '<header class="header">
            <a href="#" class="logo">
                Brgy. Sagrada System
                <img src="../../img/s.png" style="height:90px; width:90px;"/>
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    <a href="../../logout.php" class="btn btn-default btn-flat" style="margin-right: 24px; margin-top: 10px;"><span class="glyphicon glyphicon-user"></span> Sign out</a>
                </div>
            </nav>
        </header>'; ?>

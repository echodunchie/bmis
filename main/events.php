<?php
    ...
    //fetch recent post
    $recent = mysqli_query($con,"SELECT * FROM news ORDER BY id DESC LIMIT 4");
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="news-block-four">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/sagrada.jpg" alt="">
                                <div class="date"><?php  echo $new['tdate']; ?></div>
                                <div class="overlay-two"><a href="lake.jpg" class="lightbox-image" data-fancybox="gallery"><span class="flaticon-zoom-in"></span></a></div>
                            </div>
                            <div class="lower-content">

                                <div class="category"><i class="fas fa-folder"></i> <?php echo $new['category']; ?></div>
                                <h3><a href=""><?php echo $new['title']; ?></a></h3>
                                <ul class="post-meta">
                                    <li><a href="#"><i class="far fa-user"></i>By: Admin</a></li>
                                   
                                </ul>
                                <div class="text"><p><?php echo $new['descrip']; 
                       ...
                       <!-- <div class="widget widget_categories">
                            ...
                            <div class="widget-content">
                                <ul class="categories-list clearfix">
                                    <?php
                                        ...
                                        $counter  = mysqli_query($con,"SELECT * FROM news WHERE category='".$row['cat_name']."'");
                        ...
                        <div class="widget news-widget-two">
                            ...
                            <div class="wrapper-box">
                                ...
                                ?>
                                <div class="post" style="background-image: url(kid.jpg);">
                                    <div class="content">
                                        <div class="date"><i class="far fa-calendar"></i> <?php echo $row['tdate']; ?></div>
                                        <h4><a href="?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h4>
                                    </div>
                                </div>
                             <?php } ?>
                            </div>
                        ...
                        <div class="widget tag-cloud-widget">
                            <h4 class="widget_title"> Date and Time</h4>
                              <h5 id="time">Current date and time placeholder</h5>
